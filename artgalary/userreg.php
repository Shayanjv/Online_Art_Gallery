...
<body>
    ...
    <form method="POST" action="userregisterphp.php" onsubmit="return mysubmit()"/>
   ...
   <div class="wrapper">
      <div class="login-box">
        ...
        <div class="input_box">
        <input type="number" name="phno" class="input-field">
        ...
        <div class="input_box">
        <input type="password" name="CP" class="input-field">
        <label for="user" class="label">Confirm Password</label>
          <i class="bx bx-lock-alt icon"></i>
          </div>
        <center><h6>Forget Password <a href="#" class="clickhereBtn-link">clickhere</a></h6></center>
